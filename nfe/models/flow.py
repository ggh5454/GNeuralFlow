...
from nfe.models.h_coupling_flow import ContinuousAffineCoupling
from nfe.models.mlp import MLP, MlpLN
from nfe.models.resnet_flow import ResNetFlowNF
from nfe.train_utils import set_seed
import nfe.models as mods
...
class ResNetFlow(Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        gcn_layers = []
        for _ in range(kwargs.get('gnn_layers')):
