...
Original file is located at
    https://colab.research.google.com/drive/1p-IG0lRGjoqoIBEFkOabNIA2Lh8w3qWW
...
adm_3 = pd.read_csv(f"{proc_path}/admissions_processed.csv")

# only choose previously selected admission ids
inputs=pd.read_csv(f'{icu_path}/inputevents.csv.gz')
...
# inputs_small_4 = pd.concat([df_new1, pd.DataFrame([df_temp2,df_new3,df_temp4])], ignore_index=True)
#The result is a dataset with discrete inputs for each treatment.

inputs_small_4.to_csv(f"{proc_path}/inputs_processed.csv")
